...
public class AffectationHashMap {
    ...
    public void supprimerEmploye(Employe e){
        ...
        mapEmp.remove(e);
        System.out.println("Employe est supprimeé avec succes");
    }

    public void supprimerEmployeEtDepartement (Employe e, Departement d){
        if(mapEmp.remove(e,d)) {
            System.out.println("Employe et Departement sont supprimeés avec succes");
        }else {
            System.out.println("Impossbile de supprimer");
        }
    }
